...
IMAGE_PATH = os.path.join(dir_of_interest, "images", "tip.jfif")
...
fig_1 = px.histogram(df[df['sex'] == Sex], y="tip")
col1.plotly_chart(fig_1, use_container_width=True)

fig_2 = px.box(df[df['sex'] == Sex], y="tip")
col2.plotly_chart(fig_2, use_container_width=True)

col3, col4 = st.columns(2)
fig_3 = px.scatter(df[df['sex'] == Sex], y="tip")
col3.plotly_chart(fig_3, use_container_width=True)

fig_4 = px.bar(df[df['sex'] == Sex], y="tip")
